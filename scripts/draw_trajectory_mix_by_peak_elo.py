...
OUTPUT = BASE / "career_trajectory_mix_by_peak_elo.png"
DATA_OUTPUT = BASE / "career_trajectory_mix_by_peak_elo.csv"
...
def main() -> None:
    ...
    counts = pd.crosstab(data["peak_elo_level"], data["raw_elo_cluster"]).reindex(labels).fillna(0)
